# Continuando a Aprender e dominar a linguagem Javascript
***
Após aprender o básico com o Professor Gustavo Guanabara, dedico parte do meu tempo a aprender de forma mais consistente javascript.

## Objetivos
- [x] Entender o básico
- [x] Aprender a manipular arrays
- [x] Aprender a manipular Html e Css com Javascript
- [ ] Aprender programação assíncrona
